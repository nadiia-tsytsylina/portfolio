export const projects = [
  {
    id: 12,
    title: 'CapQuest',
    demo: 'https://app.capquest.io/',
    landing: 'https://capquest-land-beta-prod-105d286ba11a.herokuapp.com/',
    img: 'https://res.cloudinary.com/dn4dxdwur/image/upload/v1758804587/projects/capQuest_ujbuev.png',
    description:
      'CapQuest is an advanced corporate equity management platform, enabling companies to efficiently structure shares, onboard stakeholders with role-based access, and monitor investments through dynamic, interactive dashboards. With its intuitive interface and scenario simulation tools, CapQuest empowers organizations to make informed decisions and optimize their capital management processes.',
    technologies: [
      'TypeScript',
      'React',
      'ReactQuery',
